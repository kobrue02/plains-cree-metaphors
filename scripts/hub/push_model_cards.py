"""Push model cards to the HuggingFace Hub for all trained checkpoints; run directly to (re)push cards for everything, e.g. after adding a new ablation condition or a failed push."""
